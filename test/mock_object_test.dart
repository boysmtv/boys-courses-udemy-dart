...
void main(){
  group("BookService", (){
    ...
    test("Find book by id Dedy123", (){
      when(bookRepository.findById(argThat(startsWith("Dedy"))))
          .thenReturn(Book("Dedy123", "Tutorial Dart", 100000));

      var book = bookService.find("Dedy123");
      expect(book, equals(Book("Dedy123", "Tutorial Dart", 100000)));
